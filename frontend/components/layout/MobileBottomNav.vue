  ...
  <nav class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-40">
    <div class="flex items-stretch justify-around h-14">
      ...
      >
        ...
        <span class="text-[11px] font-medium leading-none">{{ t('nav.home') }}</span>
      </NuxtLink>
      ...
      >
        ...
        <span class="text-[11px] font-medium leading-none">{{ t('nav.all') }}</span>
      </NuxtLink>
      ...
      >
        ...
        <span class="text-[11px] font-medium leading-none">{{ t('nav.post') }}</span>
      </NuxtLink>
      <NuxtLink
        v-else
        to="/boards"
      ...
      >
        ...
        <span class="text-[11px] font-medium leading-none">{{ t('nav.boards') }}</span>
      </NuxtLink>
      ...
      >
        ...
        <span class="text-[11px] font-medium leading-none">{{ t('nav.search') }}</span>
      </NuxtLink>
      ...
      >
        ...
        <span class="text-[11px] font-medium leading-none">{{ t('nav.inbox') }}</span>
      </NuxtLink>
      <NuxtLink
        v-else
        to="/login"
      ...
      >
        ...
        <span class="text-[11px] font-medium leading-none">{{ t('nav.logIn') }}</span>
      </NuxtLink>
    </div>
